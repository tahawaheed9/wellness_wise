...
class KidneyPredictionChart extends StatefulWidget {
  const KidneyPredictionChart({super.key});

  @override
  State<KidneyPredictionChart> createState() => _KidneyPredictionChartState();
}

class _KidneyPredictionChartState extends State<KidneyPredictionChart> {
