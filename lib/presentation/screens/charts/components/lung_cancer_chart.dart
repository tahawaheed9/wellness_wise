...
class LungCancerChart extends StatefulWidget {
  const LungCancerChart({super.key});

  @override
  State<LungCancerChart> createState() => _LungCancerChartState();
}

class _LungCancerChartState extends State<LungCancerChart> {
